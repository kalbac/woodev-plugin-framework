									...
									<ul style="margin:0;">
										...
										foreach ( $payment_tokens as $token ) :
											...
											<li>
												...
												(
												<?php
												printf( '%s заканчивается на %s истекает %s', $token->get_type_full(), $token->get_last_four(), $token->get_exp_month() . '/' . $token->get_exp_year() );
