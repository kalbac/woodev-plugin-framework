...
if ( ! class_exists( 'Woodev_Payment_Gateway_Payment_Tokens_Handler' ) ) :
	...
	class Woodev_Payment_Gateway_Payment_Tokens_Handler {
		 ...
		 * @param string      $token payment token
		 * @param string|null $environment_id optional environment id, defaults to plugin current environment
		 * @return Woodev_Payment_Gateway_Payment_Token|null payment token object or null
		 */
		 ...
		 * @return int|false result of update_user_meta, or false if token not found
		 */
		...
		public function get_tokens( $user_id, $args = array() ) {
			 ...
			 * @param Woodev_Payment_Gateway_Payment_Tokens_Handler $instance tokens handler instance
			 */
		 ...
		 * @param string|null $environment_id optional environment id, defaults to plugin current environment
		 * @return int|false updated user meta ID, or false on failure
		 */
