<?php
/**
 * WooCommerce-coupled license settings admin handler.
 *
 * The licensing settings page is only relevant for plugins running on
 * WooCommerce. This class owns the woocommerce_screen_ids filter registration
 * so that pure-WP plugins do not pull in the WC coupling in is_admin().
 *
 * The framework loader (Woodev_Plugin::load_license_settings_fields) gates
 * the require_once + instantiation on Woodev_Helper::is_woocommerce_active().
 *
 * @since 2.0.0
 */
...
if ( ! class_exists( Woodev_Woocommerce_License_Settings::class, false ) ) :

	class Woodev_Woocommerce_License_Settings {
