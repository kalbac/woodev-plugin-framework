/*!
 * IMask.js v7.6.1 (https://imask.js.org)
 * Repository: https://github.com/uNmAnNeR/imaskjs
 * License: MIT (https://github.com/uNmAnNeR/imaskjs/blob/master/LICENSE)
 *
 * Vendored verbatim (unminified beyond upstream's own build) — card #503 round 2, the
 * IMask rewrite of the checkout phone mask. Fetched from
 * https://cdn.jsdelivr.net/npm/imask@7.6.1/dist/imask.min.js on 31.08.2026 — 59248 bytes,
 * matching the size measured before choosing IMask over Inputmask (254735 B minified).
 * To bump: fetch the new pinned URL, replace this file's body below the header, and
 * update BOTH the version number in this header AND the `wp_enqueue_script()` version
 * string for the `woodev-imask` handle in class-checkout-handler.php.
 */
