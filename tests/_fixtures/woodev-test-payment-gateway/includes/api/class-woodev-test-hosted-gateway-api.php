...
class Woodev_Test_Hosted_Payment_Gateway_API extends Woodev_API_Base implements Woodev_Payment_Gateway_API {

	private Woodev_Payment_Gateway_Hosted $gateway;

	public function __construct( Woodev_Payment_Gateway_Hosted $gateway ) {
