...
class PlatformNeutralHelperTest extends TestCase {
	 ...
	 *
	 * As of 2.0.0 the helper lives on {@see \Woodev\Framework\Woocommerce_Helper}; the
	...
	public function test_shop_has_virtual_products_returns_false_without_woocommerce(): void {
		$this->assertFalse( \Woodev\Framework\Woocommerce_Helper::shop_has_virtual_products() );
	}
