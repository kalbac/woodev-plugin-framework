> Archived s60 (2026-08-09): S3.3 merged to main (PR #35, 2026-06-11); the frozen wire contract lives on in platform-v2-s3-licensing-webhooks-spec.md (kept in place).
