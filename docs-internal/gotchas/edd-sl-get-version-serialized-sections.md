...
- [updater-cache-source-stamp-not-key](updater-cache-source-stamp-not-key.md) — same updater, F10 cache value-stamp.
- [in-plugin-update-message-arg-shape](in-plugin-update-message-arg-shape.md) — same updater, F8 hook arg shape.
