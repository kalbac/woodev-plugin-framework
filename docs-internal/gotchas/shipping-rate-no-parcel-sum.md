...
- `docs-internal/archive/platform-v2-s3-shipping-rate-packing-spec.md` — the full design (Variant B)
- `docs-internal/archive/platform-v2-s2-boxpacker-spec.md` — the packer/dispatcher producing the parcels
- [contract-string-not-derivable](contract-string-not-derivable.md) — another "the plugin must supply carrier specifics" rule
