...
**Docs:** ADR-007 (React admin stack); B-7/B-8/B-12 closed in FUTURE-BACKLOG; gotchas [wp-scripts-jsx-runtime-wp66](../gotchas/wp-scripts-jsx-runtime-wp66.md), [rest-cookie-nonce-auth-semantics](../gotchas/rest-cookie-nonce-auth-semantics.md).
