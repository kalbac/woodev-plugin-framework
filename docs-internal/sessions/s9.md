...
**Docs:** spec §5 rewritten as the frozen-contract table (§9 marked resolved); need-license spec §4 marked IMPLEMENTED; plan carries all rulings; tracker updated; gotchas [phpunit-takes-one-path-and-silently-ignores-the-rest](../gotchas/phpunit-takes-one-path-and-silently-ignores-the-rest.md), [wpenv-windows-gitbash-path-mangling](../gotchas/wpenv-windows-gitbash-path-mangling.md), [patchwork-early-load-bootstrap](../gotchas/patchwork-early-load-bootstrap.md).
